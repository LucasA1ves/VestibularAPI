...
namespace VestibularAPI.Migrations
{
    ...
    [Migration("20240814215731_AtualizarRelacionamentosSemObjetos")]
    partial class AtualizarRelacionamentosSemObjetos
    {
            ...
            modelBuilder.Entity("Inscricao", b =>
                {
                    ...
                    b.Property<int?>("OfertaId1")
                        .HasColumnType("int");

                    b.Property<int>("ProcessoSeletivoId")
                        .HasColumnType("int");

                    b.Property<int?>("ProcessoSeletivoId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OfertaId1");

                    b.HasIndex("ProcessoSeletivoId");

                    b.HasIndex("ProcessoSeletivoId1");
            ...
            modelBuilder.Entity("Inscricao", b =>
                {
                    ...
                    b.HasOne("ProcessoSeletivo", null)
                        .WithMany("Inscricoes")
                        .HasForeignKey("ProcessoSeletivoId1");
                });
