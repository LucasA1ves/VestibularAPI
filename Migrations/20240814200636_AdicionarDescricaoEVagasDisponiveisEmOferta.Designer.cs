...
namespace VestibularAPI.Migrations
{
    ...
    [Migration("20240814200636_AdicionarDescricaoEVagasDisponiveisEmOferta")]
    partial class AdicionarDescricaoEVagasDisponiveisEmOferta
    {
            ...
            modelBuilder.Entity("VestibularAPI.Models.Inscricao", b =>
                {
                    ...
                    b.HasOne("VestibularAPI.Models.ProcessoSeletivo", "ProcessoSeletivo")
                        .WithMany()
